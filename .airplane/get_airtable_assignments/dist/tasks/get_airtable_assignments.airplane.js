  ...
  "../node_modules/@airplane/lib/internal/fetcher.js"(exports) {
    ...
    var Fetcher = class {
      ...
      async request(path, method, opts = {}) {
        ...
        const headers = {};
        for (const [k, v] of Object.entries((_b = opts.headers) !== null && _b !== void 0 ? _b : {})) {
          if (v) {
            headers[k] = v;
          }
        }
        ...
        const idempotencyKey = opts.idempotencyKey || ((_c = opts.headers) === null || _c === void 0 ? void 0 : _c["Idempotency-Key"]) || (0, uuid_1.v4)();
        ...
        return fetchWithRetries({
          ...
          // Default to 10s.
          timeoutMs: (_d = opts.timeoutMs) !== null && _d !== void 0 ? _d : 1e4,
          retryDelay: (_e = this.opts.retryDelay) !== null && _e !== void 0 ? _e : exports.defaultRetryDelay,
          mode: this.opts.mode,
    ...
    var parseRetryAfter = (header) => {
      ...
      return Math.max(0, date.getTime() - (/* @__PURE__ */ new Date()).getTime());
    };
...
var require_config = __commonJS({
  "../node_modules/airplane/internal/config.js"(exports) {
    ...
    var humanize_string_1 = __importDefault((init_humanize_string(), __toCommonJS(humanize_string_exports)));
    var ts_dedent_1 = require_dist2();
    var execute_1 = require_execute();
...
// ../tasks/get_airtable_assignments.airplane.ts
var get_airtable_assignments_airplane_exports = {};
__export(get_airtable_assignments_airplane_exports, {
  default: () => get_airtable_assignments_airplane_default
});
module.exports = __toCommonJS(get_airtable_assignments_airplane_exports);
var import_airplane = __toESM(require_airplane());
var import_airtable = __toESM(require("airtable"));
var get_airtable_assignments_airplane_default = import_airplane.default.task(
  {
  ...
  async () => {
    ...
    let data = [];
    var base = new import_airtable.default({ apiKey: "patEYp2SibdcMbAja.5e45d430a04d8651095c81d933a5432465443e37ee3f3dcfa1dc67ac8a1e6559" }).base("appRwVDwo7wPhV87g");
